...
libraryDependencies ++= Seq(
  ...
  "org.clapper" %% "grizzled-slf4j" % "1.3.3",
   "org.apache.kafka" %% "kafka" % "2.4.0" exclude("org.apache.zookeeper","zookeeper") exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") force(),  "org.apache.kafka" % "kafka-streams" % "2.2.0",
